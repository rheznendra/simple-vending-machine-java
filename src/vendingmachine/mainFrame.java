...
public class mainFrame extends javax.swing.JFrame {
	...
	private int saldo = 0;
	private final String[] kodeMinuman = {"A1", "B1", "C1", "A2", "B2", "C2", "A3", "B3", "C3", "A4", "B4", "C4"};
    ...
    private void initComponents() {
        ...
        cocaColaImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/coca-cola.png"))); // NOI18N
        ...
        cocaColaImg1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/coca-cola-zero.png"))); // NOI18N
        ...
        cocaColaImg2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/sprite.png"))); // NOI18N
        ...
        spriteLightImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/sprite-light.png"))); // NOI18N
        ...
        cocaColaImg3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fanta-strawberry.png"))); // NOI18N
        ...
        cocaColaImg4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fanta-orange.png"))); // NOI18N
        ...
        cocaColaImg5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pocari-sweat.png"))); // NOI18N
        ...
        capPandaImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/cap-panda.png"))); // NOI18N
        ...
        cocaColaImg7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/green-sands.png"))); // NOI18N
        ...
        cocaColaImg9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/nescafe-original.png"))); // NOI18N
        ...
        cocaColaImg8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/nescafe-mocha.png"))); // NOI18N
        ...
        cocaColaImg6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/nescafe-latte.png"))); // NOI18N
		...
		if (dialog != null && !dialog.isBlank()) {
			...
			if (!dialog.matches("^[0-9]*$")) {
				...
				if (nominal == 2000 || nominal == 5000 || nominal == 10000) {
					saldo += Integer.parseInt(dialog);
					currentSaldo.setText(String.valueOf(new CurrencyID(saldo)));
				} else {
    ...
    private void btEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnterActionPerformed
		String kodeSelected = itemLabel.getText();
		if(!ArrayUtils.contains(kodeMinuman, kodeSelected)) {
			JOptionPane.showMessageDialog(this, "Kode Minuman Tidak Tersedia.");
		} else {
//			saldo -=
			itemLabel.setText("");
		}
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
		String item = itemLabel.getText();
		if (item.length() >= 1) {
			itemLabel.setText(item.substring(0, itemLabel.getText().length() - 1));
		}
	...
	private void setItemLabel(String text) {
		String item = itemLabel.getText();
		if (item.length() < 2) {
			item = item + text;
